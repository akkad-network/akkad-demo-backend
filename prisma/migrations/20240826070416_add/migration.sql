-- CreateTable
CREATE TABLE `PositionHistoryRecords` (
    ...
    `funding_fee_is_positive` BOOLEAN NULL,
    `last_funding_rate` VARCHAR(191) NOT NULL,
    `last_funding_is_positive` BOOLEAN NULL,
    ...
    `created_transaction_version` VARCHAR(191) NULL,
